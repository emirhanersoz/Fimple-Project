...
{
    public class DepositAndWithdrawQueryHandler:
        IFiRequestHandler<GetDepositAndWithdrawByParametersQuery, List<DepositAndWithdrawOutputModel>>,
        IFiRequestHandler<GetDepositAndWithdrawByKeyQuery, DepositAndWithdrawOutputModel>
    {
        ...
        public DepositAndWithdrawQueryHandler(ISessionContextDI sessionDI, IFiModuleDbContext dbContext, 
        ...
        public async Task<DepositAndWithdrawOutputModel> Handle(GetDepositAndWithdrawByKeyQuery message, CancellationToken cancellationToken)
        {
