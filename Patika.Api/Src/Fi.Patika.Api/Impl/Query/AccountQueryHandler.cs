...
namespace Fi.Patika.Api.Impl.Query
{
    public class AccountQueryHandler:
        IFiRequestHandler<GetAccountByParametersQuery, List<AccountOutputModel>>,
        IFiRequestHandler<GetAccountByKeyQuery, AccountOutputModel>
    {
        ...
        public AccountQueryHandler(ISessionContextDI sessionDI, IFiModuleDbContext dbContext, 
        ...
        public async Task<AccountOutputModel> Handle(GetAccountByKeyQuery message, CancellationToken cancellationToken)
        {
