...
{
    public class AccountCreditCommandHandler :
        IFiRequestHandler<CreateAccountCreditCommand, AccountCreditOutputModel>
    {
        ...
        public AccountCreditCommandHandler(ISessionContextDI sessionDI, IFiModuleDbContext dbContext,
        ...
        public async Task<AccountCreditOutputModel> Handle(CreateAccountCreditCommand message, CancellationToken cancellationToken)
        {
